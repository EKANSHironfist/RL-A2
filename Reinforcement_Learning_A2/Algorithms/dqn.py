...
class DQNagent:
    def __init__(self, env, learning_rate = 0.001, gamma = 0.99, epsilon = 1.0, epsilom_min = 0.01, epsilon_decay = 0.995):
        self.env = env
    ...
    def train(self, num_episodes = 500):
        ...
        for episode in range(num_episodes):
            ...
            if episode % 10 == 0:
                ...
                print(f"Episode {episode}, Reward: {episode_reward:.1f}, Avg Reward (last 10): {avg_reward:.1f}, Epsilon: {self.epsilon:.3f}")
